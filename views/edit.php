...
?>
<h1><?=isset($id) ? __('Edit Download') . " (#$id): $name" : __('New Download');?></h1>
<form method="post" enctype="multipart/form-data" action="<?=isset($id) ? get_url('plugin/downloads/update/'.$id) : get_url('plugin/downloads/create'); ?>">
	<fieldset style="padding: 0.5em;">
		<legend style="padding: 0em 0.5em 0em 0.5em; font-weight: bold;"><?php echo __('File'); ?></legend>
		<? if (isset($id)) echo "<a href=\"/download-file/{$id}/{$filename}\" target=\"_blank\">{$filename}</a>"; ?><br />
	...
	<fieldset style="padding: 0.5em;">
		...
		<table class="fieldset" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td class="field"><textarea name="description" id="description" rows="4" cols="35"><?=isset($description) ? $description : '';?></textarea></td>
			...
			<tr>
				...
				<td class="field"><input name="keywords" id="keywords" type="text" size="35" maxsize="255" value="<?=isset($keywords) ? $keywords : '';?>" /></td>
			...
			<tr>
				...
				<td class="field"><input name="tags" id="tags" type="text" size="35" maxsize="255" value="<?=isset($tags) ? $tags : '';?>"/></td>
...
<script type="text/javascript" src="<?=PLUGINS_URI;?>/downloads/js/jquery.maskedinput-1.2.2.min.js"></script>
<script type="text/javascript" src="<?=PLUGINS_URI;?>/downloads/js/jquery.autocomplete.pack.js"></script>
...
$(document).ready(function() {
	...
	$('#tags').autocomplete('<?=get_url('plugin/downloads/autocomplete/tags');?>', {
		multiple: true,
		autoFill: true
	});
});
